...
function Navbar() {
  ...
  // Allows us to change/navigate to another route programmatically.
  const navigate = useNavigate();

  const [isOpen, setIsOpen] = useState(false);

  /*
    This function is used for navigation to SECTIONS
    that exist inside the Home page.
    ...
    It scrolls to an element on the current Home page.
  */
  const scrollToSection = (id: string) => {
    ...
    /*
      ...
      simply find the element with the matching ID
      and scroll to it.
    ...
    */
    ...
    /*
      If we are currently on another page,
      first go back to the Home page.
    */
    navigate("/");

    /*
      After the Home page loads, find the section
      and scroll to it.
  ...
  */
  const navItems = [
    /*
      ...
      Means:
      "Don't open another route.
       Find this ID on the Home page and scroll to it."
    */
    {
      label: "Home",
      type: "section",
    ...
    /*
      ...
      Means:
      "Open a different React Router page."

      Clicking this will go to:
    ...
    */
    ...
    /*
      Clicking Events will open:

      /events

      This means you should have a route
      somewhere like:
  ...
  /*
    Prevent the Home page from scrolling
    behind the mobile navigation drawer.
  */
  useEffect(() => {
  ...
  /*
    Whenever the URL/page changes,
    automatically close the mobile drawer.
  */
  useEffect(() => {
    setIsOpen(false);
  }, [location.pathname]);
        ...
        <div className="flex items-center justify-between px-4 backdrop-blur-xl sm:px-6 p-1">
          ...
          <div className="hidden items-center gap-1 lg:flex">
            ...
            {navItems.map((item) => {
              ...
              /*
                ...
                This DOES NOT open a new route.
              ...
              */
              ...
              /*
                ...
                Because this is a React Router <Link>,
                clicking it changes the URL to:

                /events

                React Router then looks for:

                <Route path="/events" element={<Events />} />

                and renders the Events component.
              */
              return (
                <motion.div
                  key={item.path}
          ...
          <div className="flex items-center gap-2">
            ...
            <motion.button
              ...
              /*
                Let's Talk is a SECTION action.

                It does:

                scrollToSection("contact")

                Therefore it goes to:
        ...
        {isOpen && (
          <>
            ...
            <motion.aside
              ...
              className="fixed right-0 top-0 z-[70] flex h-full w-[88%] max-w-sm flex-col bg-gradient-to-tl from-blue-100 via-amber-50 to-white shadow-2xl lg:hidden"
            >
              {/* Drawer Header */}
              ...
              <div className="flex items-center justify-between border-b border-white/40 px-6 py-5">
                ...
                <motion.button
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full border border-slate-200 bg-white/70 text-slate-700 transition-colors hover:bg-white"
                >
                  <X size={20} />
                </motion.button>
              </div>
              ...
              <div className="flex flex-1 flex-col px-6 py-8">
                    ...
                    if (item.type === "section") {
                      return (
                        <motion.button
                          ...
                          onClick={() => scrollToSection(item.id!)}
                          className="group flex w-full items-center justify-between rounded-xl px-3 py-4 text-left text-base font-medium text-slate-700 transition-all hover:bg-white/60 hover:text-slate-950"
                        >
                    ...
                    */
                    return (
                      ...
                      >
                        <Link
                          to={item.path!}
                          className="group flex w-full items-center justify-between rounded-xl px-3 py-4 text-base font-medium text-slate-700 transition-all hover:bg-white/60 hover:text-slate-950"
                        >
                          <span>{item.label}</span>
                ...
                <div className="mt-auto pt-8">
                  ...
                  <motion.button
                    ...
                    /*
                      Again, this is a section navigation.
                  ...
                  <p className="mt-5 text-center text-xs leading-relaxed text-slate-400">
                    Strategic consulting for businesses ready to grow with clarity
                    and confidence.
                  </p>
                </div>
              </div>
